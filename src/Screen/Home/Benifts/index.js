          ...
          <Grid container style={{ justifyContent: "center" }}>
            <Grid item lg={5} md={5} sm={5.8} className="benefits_img">
              ...
              <div style={{ marginTop: "-61%" }}>
                ...
                >
                  Play favorite games on BGV gaming channel and earn BGV tokens
                </p>
              </div>
            </Grid>
            <Grid item lg={1} md={0.6} sm={0.4}></Grid>
            <Grid item lg={5} md={5} sm={5.8} className="benefits_img">
              ...
              <div style={{ marginTop: "-61%" }}>
                ...
                <p
                  ...
                  id="trading_icon"
                >
                  Holders of BGVT tokens can participate in the governance of
                  the platform
                </p>
              </div>
            </Grid>
          ...
          <Grid container style={{ justifyContent: "center" }}>
            <Grid item lg={5} md={5} sm={5.8} className="benefits_img">
              ...
              <div style={{ marginTop: "-61%" }}>
                ...
                >
                  The supply of BGVT tokens is limited, & the value of the
